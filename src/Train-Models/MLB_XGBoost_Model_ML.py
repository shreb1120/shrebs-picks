"""Train XGBoost moneyline model for MLB with walk-forward CV."""
...
def sample_params(rng, seed):
    ...
    num_boost_round = int(rng.integers(300, 3001))
...
def main():
    parser = argparse.ArgumentParser(description="Train MLB XGBoost moneyline model.")
    ...
    params = best["params"]
    model_name = (
        f"MLB_XGBoost_{accuracy * 100:.1f}%_ML"
